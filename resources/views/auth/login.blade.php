...
<head>
    ...
    <title>Login | Porto Ecommerce</title>
    <!--favicon-->
                ...
                <div class="col-12 col-lg-10 mx-auto">
                    <div class="card radius-15">
                        <div class="row no-gutters">
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mt-md-5">
                                    <form action="{{ route('staff.login') }}" method="post">
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <span class="text-danger font-italic"> @error('email') {{ $message }}
                                                @enderror</span>
                            ...
                            <div class="col-lg-6">
                                <img src="{{ asset('theme/backend/assets/images/login-images/login-frent-img.jpg') }}"
